...
vgg_checkpoint_path = FLAGS.checkpoint_path  #checkpoint_path
...
with slim.arg_scope(vgg.vgg_arg_scope()):  #调用vgg
...
downsampled_logits_shape = tf.shape(logits)  #下采样
...
with tf.variable_scope("adam_vars"):
    ...
    gradients = optimizer.compute_gradients(loss=cross_entropy_loss)  #计算梯度
    ...
    for grad_var_pair in gradients:
        ...
        tf.summary.histogram(gradient_name_to_save, current_gradient)  #记录梯度
